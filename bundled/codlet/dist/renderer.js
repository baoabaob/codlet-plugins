...
function createMessages(context) {
  const TRANSLATIONS = {
    ...
    "Star Codlet on GitHub": "\u5728 GitHub \u4E3A Codlet \u70B9 Star",
...
function createProjectLinks({ React: React2, C: C2, I: I2, t: t2 }) {
  ...
  return function ProjectLinks2() {
    return /* @__PURE__ */ h2("div", { className: "codlet-project-links" }, /* @__PURE__ */ h2(C2.ButtonLink, { href: repositoryUrl, color: "secondary", variant: "ghost", size: "sm", external: true, target: "_blank", rel: "noopener noreferrer", "aria-label": t2("Open Codlet on GitHub") }, "GitHub", /* @__PURE__ */ h2(I2.ArrowUpRight, null)), /* @__PURE__ */ h2(C2.ButtonLink, { href: repositoryUrl, className: "codlet-star-link", color: "secondary", variant: "outline", size: "sm", pill: false, external: true, target: "_blank", rel: "noopener noreferrer", "aria-label": t2("Star Codlet on GitHub") }, /* @__PURE__ */ h2(I2.Star, null), "Star"));
  };
}
