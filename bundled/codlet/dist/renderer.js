...
function createProjectLinks({ React: React2, C: C2, t: t2 }) {
  const h2 = React2.createElement;
  return function ProjectLinks2() {
    return /* @__PURE__ */ h2("div", { className: "codlet-project-links" }, /* @__PURE__ */ h2(C2.Tooltip, { content: t2("Leave a star~ \u2B50\uFE0F") }, /* @__PURE__ */ h2(C2.TextLink, { href: repositoryUrl, className: "codlet-project-link", target: "_blank", rel: "noopener noreferrer", "aria-label": t2("Open Codlet on GitHub") }, "GitHub")));
  };
}
